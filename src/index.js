var kyber = (function () {
  ...
  function E(A, I) {
    if (0 === A) return I;
    throw new Error("Kyber error: " + A);
  }
  function C(A, I) {
    return new Uint8Array(new Uint8Array(Q.HEAPU8.buffer, A, I));
  }
  function i(A) {
    try {
      Q._free(A);
  ...
  Q.ready = new Promise(function (A, I) {
    ...
    (((E = {}).onAbort = I),
      (E.onRuntimeInitialized = function () {
        try {
          (E._kyberjs_public_key_bytes(), A(E));
        } catch (A) {
          I(A);
        }
      }));
    var B,
      ...
      n = "object" == ("undefined" == typeof window ? "undefined" : g(window)),
      r = "function" == typeof importScripts,
      o =
        "object" ==
          ("undefined" == typeof process ? "undefined" : g(process)) &&
        "object" == g(process.versions) &&
        "string" == typeof process.versions.node,
      t = "";
    if (o) {
      var e = eval("require")("fs"),
        a = eval("require")("path");
      ((t = r ? a.dirname(t) + "/" : __dirname + "/"),
        (B = function (A, I) {
          var g = V(A);
          return g
            ? I
              ? g
              : g.toString()
            : ((A = H(A) ? new URL(A) : a.normalize(A)),
              e.readFileSync(A, I ? void 0 : "utf8"));
        }),
        (Q = function (A) {
          var I = B(A, !0);
        ...
        function (A, I, g) {
          ...
          (Q && I(Q),
            (A = H(A) ? new URL(A) : a.normalize(A)),
            e.readFile(A, B ? void 0 : "utf8", function (A, Q) {
              A ? g(A) : I(B ? Q.buffer : Q);
            }));
        },
        !E.thisProgram &&
        ...
        process.on("uncaughtException", function (A) {
          if (!("unwind" === A || A instanceof q || A.context instanceof q))
            throw A;
        }),
        (i = function (A, I) {
            ...
            if (g)
              return (function (A) {
                for (var I = [], g = 0; g < A.length; g++) {
                  var B = A[g];
                  (B > 255 && (B &= 255), I.push(String.fromCharCode(B)));
                }
                return I.join("");
              })(g);
            throw I;
    ...
    var c,
      D = E.noExitRuntime || !0;
    "object" !=
      ("undefined" == typeof WebAssembly ? "undefined" : g(WebAssembly)) &&
    ...
    function l(A) {
      return Promise.resolve().then(function () {
        return (function (A) {
          if (A == Y && s) return new Uint8Array(s);
          var I = V(A);
          if (I) return I;
          if (Q) return Q(A);
    ...
    function m(A, I, g, B) {
      return (function (A, I, g) {
        return l(A)
          ...
          .then(g, function (A) {
            (f("failed to asynchronously prepare wasm: " + A), U(A));
          });
      })(I, g, B);
    }
    M(
    ...
    ) || ((N = Y), (Y = E.locateFile ? E.locateFile(N, t) : t + N));
    var J = {
      1572: function () {
    ...
    var x,
      ...
      K = function (A, I, g) {
        var B = (function (A, I) {
          var g;
          for (v.length = 0, I >>= 2; (g = w[A++]); )
            ((I += (105 != g) & I), v.push(105 == g ? u[I] : G[I++ >> 1]), ++I);
          return v;
        })(I, g);
        return J[A].apply(null, B);
      },
      W = function (A) {
        (A, D || (E.onExit && E.onExit(A), (F = !0)), i(A, new q(A)));
      },
      O = {
        b: function (A, I, g) {
          return K(A, I, g);
    ...
    ((function () {
      ...
      function I(A, I) {
        ...
        return (
          ...
          (c = E.asm.e),
          (g = c.buffer),
          (E.HEAP8 = y = new Int8Array(g)),
          (E.HEAP16 = new Int16Array(g)),
          (E.HEAP32 = u = new Int32Array(g)),
          (E.HEAPU8 = w = new Uint8Array(g)),
          (E.HEAPU16 = new Uint16Array(g)),
          (E.HEAPU32 = new Uint32Array(g)),
          (E.HEAPF32 = new Float32Array(g)),
          (E.HEAPF64 = G = new Float64Array(g)),
          E.asm.g,
          (B = E.asm.f),
          S.unshift(B),
          (function (A) {
            if (
              (R--,
              E.monitorRunDependencies && E.monitorRunDependencies(R),
              0 == R && (null !== p && (clearInterval(p), (p = null)), d))
            ) {
              var I = d;
              ((d = null), I());
            }
      ...
      if (
        ...
        try {
          ...
          return (
            f("Module.instantiateWasm callback failed with error: " + A),
            !1
          );
        }
      m(0, Y, A, function (A) {
      ...
      (E._malloc = function () {
        return (E._malloc = E.asm.h).apply(null, arguments);
      }),
      (E._free = function () {
        return (E._free = E.asm.i).apply(null, arguments);
      }),
      (E._kyberjs_init = function () {
        return (E._kyberjs_init = E.asm.j).apply(null, arguments);
      }),
      (E._kyberjs_public_key_bytes = function () {
        return (E._kyberjs_public_key_bytes = E.asm.k).apply(null, arguments);
      }),
      (E._kyberjs_private_key_bytes = function () {
        return (E._kyberjs_private_key_bytes = E.asm.l).apply(null, arguments);
      }),
      (E._kyberjs_cyphertext_bytes = function () {
        return (E._kyberjs_cyphertext_bytes = E.asm.m).apply(null, arguments);
      }),
      (E._kyberjs_secret_bytes = function () {
        return (E._kyberjs_secret_bytes = E.asm.n).apply(null, arguments);
      }),
      (E._kyberjs_keypair = function () {
        return (E._kyberjs_keypair = E.asm.o).apply(null, arguments);
      }),
      (E._kyberjs_encrypt = function () {
        return (E._kyberjs_encrypt = E.asm.p).apply(null, arguments);
      }),
      (E._kyberjs_decrypt = function () {
        return (E._kyberjs_decrypt = E.asm.q).apply(null, arguments);
      }));
    function V(A) {
      if (M(A))
        return (function (A) {
          ...
          try {
            for (
              var g = atob(A), B = new Uint8Array(g.length), Q = 0;
              Q < g.length;
              ++Q
            )
              B[Q] = g.charCodeAt(Q);
    ...
    if (
      ((E.writeArrayToMemory = function (A, I) {
        y.set(A, I);
      }),
      (d = function A() {
        (x || j(), x || (d = A));
    ...
    .catch(function () {
      ...
      var I,
        ...
        n =
          "object" ==
            ("undefined" == typeof process ? "undefined" : A(process)) &&
          "object" == A(process.versions) &&
          "string" == typeof process.versions.node,
        r = "";
      if (n) {
        var o = eval("require")("fs"),
          t = eval("require")("path");
        ((r = i ? t.dirname(r) + "/" : __dirname + "/"),
          (I = function (A, I) {
            var g = T(A);
            return g
              ? I
                ? g
                : g.toString()
              : ((A = m(A) ? new URL(A) : t.normalize(A)),
                o.readFileSync(A, I ? void 0 : "utf8"));
          }),
          (g = function (A) {
            var g = I(A, !0);
          ...
          function (A, I, g) {
            ...
            (Q && I(Q),
              (A = m(A) ? new URL(A) : t.normalize(A)),
              o.readFile(A, B ? void 0 : "utf8", function (A, Q) {
                A ? g(A) : I(B ? Q.buffer : Q);
              }));
          },
          !B.thisProgram &&
      ...
      var e,
        a = B.printErr || console.error.bind(console);
      (Object.assign(B, Q),
        (Q = null),
        ...
        c = {
          ...
          Instance: function (A, I) {
            this.exports = (function (A) {
              for (var I, g = new Uint8Array(123), B = 25; B >= 0; --B)
                ((g[48 + B] = 52 + B), (g[65 + B] = B), (g[97 + B] = 26 + B));
              function Q(A, I, B) {
                for (
                  var Q,
                    E,
                  ...
                  ((Q = g[B.charCodeAt(C + 1)]),
                    (E = g[B.charCodeAt(C + 2)]),
                    (A[i++] = (g[B.charCodeAt(C)] << 2) | (Q >> 4)),
                    i < r && (A[i++] = (Q << 4) | (E >> 2)),
                    i < r && (A[i++] = (E << 6) | g[B.charCodeAt(C + 3)]));
              }
              function E() {
              ...
              return (
                ...
                (function (A) {
                  var g = A.a,
                    ...
                    o = new Uint16Array(B),
                    t = new Uint32Array(B),
                    e = (new Float32Array(B), new Float64Array(B), Math.imul),
                    a = (Math.fround, Math.abs, Math.clz32),
                    s =
                      (Math.min,
                      Math.max,
                      Math.floor,
                  ...
                  function w(A) {
                    ...
                    A: {
                        ...
                        g: if (i) {
                          ...
                          B: {
                            if (
                              ...
                              if (((n[A >> 2] = B), B)) break B;
                              ((s = T(g) & s), (n[585] = s));
                              break g;
                            }
                            if (
                              ((n[
                                (i + (n[(i + 16) >> 2] == (0 | Q) ? 16 : 20)) >>
                                  2
                              ] = B),
                              !B)
                            )
                          ...
                          ((n[(B + 24) >> 2] = i),
                            (A = n[(Q + 16) >> 2]) &&
                              ((n[(B + 16) >> 2] = A), (n[(A + 24) >> 2] = B)),
                            (A = n[(Q + 20) >> 2]) &&
                              ((n[(B + 20) >> 2] = A), (n[(A + 24) >> 2] = B)));
                        }
                        g: if (C >>> 0 <= 15)
                          ((A = (C + o) | 0),
                            (n[(Q + 4) >> 2] = 3 | A),
                      ...
                      I: if (e) {
                        g = n[(B + 28) >> 2];
                        g: {
                          if (n[(A = (2640 + (g << 2)) | 0) >> 2] == (0 | B)) {
                            if (((n[A >> 2] = Q), Q)) break g;
                            n[585] = T(g) & s;
                            break I;
                          }
                          if (
                            ((n[
                              (e + (n[(e + 16) >> 2] == (0 | B) ? 16 : 20)) >> 2
                            ] = Q),
                            !Q)
                          )
                            break I;
                        ...
                        ((n[(Q + 24) >> 2] = e),
                          (A = n[(B + 16) >> 2]) &&
                            ((n[(Q + 16) >> 2] = A), (n[(A + 24) >> 2] = Q)),
                          (A = n[(B + 20) >> 2]) &&
                            ((n[(Q + 20) >> 2] = A), (n[(A + 24) >> 2] = Q)));
                      }
                      (C >>> 0 <= 15
                        ? ((A = (C + o) | 0),
                          (n[(B + 4) >> 2] = 3 | A),
                  ...
                  function u(A) {
                    ...
                    for (
                      ...
                      ((I = e ^ a ^ f ^ b ^ AA),
                        ...
                        (eA = y),
                        (QA = N = Y ^ s ^ x ^ l ^ P),
                        (N = U((j = t ^ G ^ L ^ H ^ X), N, 1) ^ D),
                        (D = U(o ^ N, d ^ (EA = y ^ R), 10)),
                        (aA = y),
                        (CA = R = S ^ BA ^ d ^ z ^ rA),
                        (sA = F ^ C ^ J ^ T ^ $),
                        (F = U((cA = B ^ g ^ o ^ M ^ m), R, 1) ^ sA),
                        (R = U(
                          (R = Q ^ F),
                          c ^ (d = (Q = W ^ K ^ q ^ Z ^ nA) ^ y),
                          36,
                        ...
                        (S = y),
                        (c = U(sA, Q, 1) ^ j),
                        (f = U(c ^ f, (j = p) ^ (p = y ^ QA), 25)),
                        (QA = y),
                        (W = U(I, tA, 1) ^ cA),
                        (B = U(W ^ G, (j = s) ^ (s = y ^ CA), 6)),
                        (tA = y),
                        (G = U(e ^ c, h ^ p, 28)),
                        (h = y),
                        (i = U(i ^ F, d ^ v, 3)),
                        ...
                        (o = y),
                        (h = U(b, Q, 1) ^ OA),
                        (Q = U(iA ^ h, bA ^ (Y = VA ^ y), 55)),
                        (f = y),
                        (S = U(rA, MA, 1) ^ B),
                        (B = U(S ^ xA, (k = u ^ y) ^ lA, 62)),
                        (i = g = y),
                        (T = ((-1 ^ B) & Q) ^ I),
                        (Z = ((-1 ^ g) & f) ^ o),
                        (b = (g = U(D ^ pA, G ^ FA, 41)) ^ ((-1 ^ I) & B)),
                        (_ = (C = y) ^ ((-1 ^ o) & i)),
                        (X = (E = U(E ^ a, e ^ M, 39)) ^ ((-1 ^ g) & I)),
                        (P = (I = y) ^ ((-1 ^ C) & o)),
                        (M = Q ^ ((-1 ^ E) & g)),
                        (z = f ^ ((-1 ^ I) & C)),
                        (u = B ^ ((-1 ^ Q) & E)),
                        ...
                        ($ = ((-1 ^ B) & Q) ^ I),
                        (nA = ((-1 ^ g) & f) ^ o),
                        (AA = (g = U(S ^ WA, k ^ qA, 15)) ^ ((-1 ^ I) & B)),
                        (IA = (C = y) ^ ((-1 ^ o) & i)),
                        (H = (E = U(r ^ J, w ^ q, 10)) ^ ((-1 ^ g) & I)),
                        (l = (I = y) ^ ((-1 ^ C) & o)),
                        (m = Q ^ ((-1 ^ E) & g)),
                        (rA = f ^ ((-1 ^ I) & C)),
                        (gA = ((-1 ^ Q) & E) ^ B),
                        ...
                        (J = ((-1 ^ B) & Q) ^ I),
                        (q = ((-1 ^ g) & C) ^ o),
                        (f = (g = U(a ^ QA, e ^ eA, 8)) ^ ((-1 ^ I) & B)),
                        (p = (i = y) ^ ((-1 ^ o) & v)),
                        (L = (E = U(h ^ d, s ^ Y, 25)) ^ ((-1 ^ g) & I)),
                        (x = (I = y) ^ ((-1 ^ i) & o)),
                        (o = Q ^ ((-1 ^ E) & g)),
                        (d = C ^ ((-1 ^ I) & i)),
                        (i = ((-1 ^ Q) & E) ^ B),
                        ...
                        (C = ((-1 ^ B) & Q) ^ I),
                        (K = ((-1 ^ g) & e) ^ s),
                        (a = (g = U(r ^ CA, w ^ aA, 45)) ^ ((-1 ^ I) & B)),
                        (w = (r = y) ^ ((-1 ^ s) & c)),
                        (G = (E = U(D ^ dA, G ^ hA, 3)) ^ ((-1 ^ g) & I)),
                        (s = (I = y) ^ ((-1 ^ r) & s)),
                        (g = ((-1 ^ E) & g) ^ Q),
                        (BA = ((-1 ^ I) & r) ^ e),
                        (Q = B ^ ((-1 ^ Q) & E)),
                        (c ^= (-1 ^ e) & I),
                        (e = (B = U(h ^ UA, Y ^ YA, 21)) ^ ((-1 ^ t) & N)),
                        (h = (E = y) ^ ((-1 ^ O) & EA)),
                        (t = (I = U(S ^ LA, k ^ HA, 43)) ^ ((-1 ^ B) & t)),
                        (Y = (D = y) ^ ((-1 ^ E) & O)),
                        (B = ((-1 ^ I) & B) ^ R),
                        (S = ((-1 ^ D) & E) ^ V),
                        (r =
                  ...
                  function G(A) {
                    ...
                    A: if ((A |= 0)) {
                      E =
                        ((B = (A - 8) | 0) + (A = -8 & (I = n[(A - 4) >> 2]))) |
                        0;
                      I: if (!(1 & I)) {
                        if (!(3 & I)) break A;
                        if ((B = (B - (I = n[B >> 2])) | 0) >>> 0 < t[588])
                          break A;
                        A = (A + I) | 0;
                        g: {
                          B: {
                        ...
                        if (C) {
                          ...
                          g: {
                            if (
                              ...
                              if (((n[Q >> 2] = I), I)) break g;
                              n[585] = n[585] & T(g);
                              break I;
                            }
                            if (
                              ((n[
                                (C + (n[(C + 16) >> 2] == (0 | B) ? 16 : 20)) >>
                                  2
                              ] = I),
                              !I)
                            )
                          ...
                          ((n[(I + 24) >> 2] = C),
                            (g = n[(B + 16) >> 2]) &&
                              ((n[(I + 16) >> 2] = g), (n[(g + 24) >> 2] = I)),
                            (g = n[(B + 20) >> 2]) &&
                              ((n[(I + 20) >> 2] = g), (n[(g + 24) >> 2] = I)));
                        }
                      }
                      if (!(B >>> 0 >= E >>> 0) && 1 & (I = n[(E + 4) >> 2])) {
                        I: {
                          g: {
                            B: {
                              Q: {
                        ...
                        I: {
                          g: {
                            if ((Q = n[585]) & (i = 1 << g)) {
                              ...
                              ((n[(i + 16) >> 2] = B), (n[(B + 24) >> 2] = Q));
                            } else
                              ((n[585] = Q | i),
                                (n[I >> 2] = B),
                                (n[(B + 24) >> 2] = I));
                            ((n[(B + 12) >> 2] = B), (n[(B + 8) >> 2] = B));
                            break I;
                          }
                          ((A = n[(Q + 8) >> 2]),
                            (n[(A + 12) >> 2] = B),
                  ...
                  function F(A, I, g, B) {
                    var Q,
                      ...
                      f = 0;
                    for (
                      D = Q = (D - 17952) | 0, H((Q + 13824) | 0, g);
                      32 != (0 | E);
                    )
                      ((C[(((Q + 17920) | 0) + E) | 0] =
                        r[(1536 + ((g + E) | 0)) | 0]),
                        (E = (E + 1) | 0));
                    for (t = (Q + 512) | 0, g = 0; 32 != (0 | g); ) {
                      for (e = g << 3, a = (I + g) | 0, E = 0; 8 != (0 | E); )
                        ((i[(t + ((E + e) << 1)) >> 1] =
                          (0 - ((r[0 | a] >>> E) & 1)) & 1665),
                          (E = (E + 1) | 0));
                      g = (g + 1) | 0;
                    ...
                    for (
                      R((Q + 3584) | 0, (Q + 17920) | 0, 1), E = 0, g = 0;
                      ;
                    ) {
                      if (((I = 4), 4 == (0 | g))) {
                        for (; 4 != (0 | E); )
                          (h((((Q + 11776) | 0) + (E << 9)) | 0, B, 255 & I),
                            (E = (E + 1) | 0),
                            (I = (I + 1) | 0));
                        for (
                          h(Q, B, 8), d((Q + 15872) | 0), E = 0;
                          4 != (0 | E);
                        )
                          (x(
                            (((Q + 1536) | 0) + (E << 9)) | 0,
                  ...
                  function R(A, I, g) {
                    var B,
                      ...
                      s = 0,
                      f = 0;
                    for (D = B = (D - 528) | 0; 4 != (0 | o); ) {
                      for (f = ((o << 11) + A) | 0, i = 0; 4 != (0 | i); ) {
                        for (
                          g
                            ? k((B + 12) | 0, I, 255 & o, 255 & i)
                            : k((B + 12) | 0, I, 255 & i, 255 & o),
                            z((E = (B + 16) | 0), 3, (B + 12) | 0),
                            Q = 504,
                            E = b((a = ((i << 9) + f) | 0), 256, E, 504);
                          E >>> 0 <= 255;
                        ) {
                          for (
                            e = (Q - (t = ((Q >>> 0) % 3) | 0)) | 0, Q = 0;
                  ...
                  function N(A, I, g, B) {
                    ...
                    A: if ((0 | (g = e(g, 136))) != (0 | I))
                      for (
                        ...
                        if ((0 | I) == (0 | B)) break A;
                        ((C[(A + I) | 0] = r[(((Q + 16) | 0) + I) | 0]),
                          (I = (I + 1) | 0));
                      }
                    (G(n[(Q + 12) >> 2]), (D = (Q + 160) | 0));
                  }
                  function b(A, I, g, B) {
                    for (
                      var Q = 0, E = 0, C = 0, n = 0, o = 0;
                      !(
                        I >>> 0 <= E >>> 0 || (C = (Q + 3) | 0) >>> 0 > B >>> 0
                      );
                    )
                      ((o = r[((Q = (g + Q) | 0) + 2) | 0]),
                        (n = r[(Q + 1) | 0]),
                        (Q = r[0 | Q] | ((n << 8) & 3840)) >>> 0 <= 3328 &&
                          ((i[((E << 1) + A) >> 1] = Q), (E = (E + 1) | 0)),
                        (Q = C),
                        I >>> 0 <= E >>> 0 ||
                          (C = (o << 4) | (n >>> 4)) >>> 0 > 3328 ||
                  ...
                  function M(A, I) {
                    for (
                      var g = 0, B = 0, Q = 0, E = 0, n = 0, r = 0, o = 0;
                      4 != (0 | E);
                    ) {
                      for (
                        r = (e(E, 384) + A) | 0, o = ((E << 9) + I) | 0, B = 0;
                        128 != (0 | B);
                      )
                        ((Q = i[((g = ((B << 2) + o) | 0) + 2) >> 1]),
                          (n = (e(B, 3) + r) | 0),
                          (g = ((((g = i[g >> 1]) >>> 15) & 3329) + g) | 0),
                          (C[0 | n] = g),
                          (Q = (Q + ((Q >>> 15) & 3329)) | 0),
                          (C[(n + 2) | 0] = Q >>> 4),
                          (C[(n + 1) | 0] = (Q << 4) | (g >>> 8)),
                  ...
                  function H(A, I) {
                    for (
                      var g = 0, B = 0, Q = 0, E = 0, C = 0, n = 0;
                      4 != (0 | B);
                    ) {
                      for (
                        C = ((B << 9) + A) | 0, n = (e(B, 384) + I) | 0, g = 0;
                        128 != (0 | g);
                      )
                        ((E = ((g << 2) + C) | 0),
                          (Q = (e(g, 3) + n) | 0),
                          (i[E >> 1] =
                            ((r[(Q + 1) | 0] << 8) & 3840) | r[0 | Q]),
                          (i[(E + 2) >> 1] =
                            (r[(Q + 2) | 0] << 4) | (r[(Q + 1) | 0] >>> 4)),
                          (g = (g + 1) | 0));
                      B = (B + 1) | 0;
                  ...
                  function l(A) {
                    for (
                      var I = 0, g = 0, B = 0, Q = 0, E = 0, C = 0, i = 0;
                      !(!Q & (8 == (0 | g)));
                    )
                      ((E = r[(A + g) | 0]),
                        (I = 31 & (B = g << 3)),
                  ...
                  function m(A, I, g, B) {
                    var Q;
                    ((Q = AA(i[(I + 2) >> 1], i[(g + 2) >> 1])),
                      (i[A >> 1] = Q),
                      (i[A >> 1] = AA(Q, B)),
                      (i[A >> 1] = AA(i[I >> 1], i[g >> 1]) + o[A >> 1]),
                      (i[(A + 2) >> 1] = AA(i[I >> 1], i[(g + 2) >> 1])),
                      (i[(A + 2) >> 1] =
                        AA(i[(I + 2) >> 1], i[g >> 1]) + o[(A + 2) >> 1]));
                  }
                  function J(A, I, g) {
                    for (var B = 0, Q = 0, E = 0; 64 != (0 | Q); )
                      (m(
                        ((B = Q << 3) + A) | 0,
                        (I + B) | 0,
                        (g + B) | 0,
                  ...
                  function q(A) {
                    var I, g;
                    return ((A = ((I = n[392]) + (g = (A + 7) & -8)) | 0) >>>
                      0 <=
                      I >>> 0 &&
                      g) ||
                      (A >>> 0 > (((B.byteLength / 65536) | 0) << 16) >>> 0 &&
                        !(0 | c(0 | A)))
                      ? ((n[583] = 48), -1)
                      : ((n[392] = A), I);
                  }
                  function L(A, I, g, B, Q, E, i) {
                    var n;
                    for (
                      D = n = (D - B) | 0,
                        S((i = (i + n) | 0), E, I, g, 6),
                  ...
                  function K(A, I, g) {
                    for (var B = 0, Q = 0; 256 != (0 | B); )
                      ((i[((Q = B << 1) + A) >> 1] =
                        o[(g + Q) >> 1] + o[(I + Q) >> 1]),
                        (B = (B + 1) | 0));
                  }
                  function W(A) {
                    for (var I = 0, g = 0; 256 != (0 | I); )
                      ((i[(g = ((I << 1) + A) | 0) >> 1] = j(i[g >> 1])),
                        (I = (I + 1) | 0));
                  }
                  function O(A, I, g) {
                    for (var B = 0, Q = 0; 4 != (0 | B); )
                      (K(((Q = B << 9) + A) | 0, (I + Q) | 0, (g + Q) | 0),
                        (B = (B + 1) | 0));
                  }
                  function V(A) {
                    for (var I = 0; 4 != (0 | I); )
                  ...
                  function j(A) {
                    return (
                      ((A -
                        ((e((e(A, 20159) + 33554432) >> 26, 218169344) >>> 16) |
                          0)) <<
                        16) >>
                      16
                    );
                  ...
                  function Z(A) {
                    return (e(e(A, -218038272) >> 16, -3329) + A) >> 16;
                  }
                  function _(A) {
                    return A ? (31 - a((A - 1) ^ A)) | 0 : 32;
                  }
                  function X(A, I, g) {
                    L(A, I, g, 352, 32, 136, 144);
                  }
                  function P(A, I, g) {
                    L(A, I, g, 288, 64, 72, 80);
                  }
                  function z(A, I, g) {
                    Y(A, I, n[g >> 2], 168);
                  }
                  ...
                  (Q(
                    (I = r),
                    1024,
                    "cmFuZG9tYnl0ZXMAbGlic29kaXVtL3NyYy9saWJzb2RpdW0vcmFuZG9tYnl0ZXMvcmFuZG9tYnl0ZXMuYwBidWZfbGVuIDw9IFNJWkVfTUFY",
                  ),
                    Q(
                      I,
                      1120,
                      "",
                    ),
                    Q(I, 1568, "EAuA"));
                  var gA,
                    BA =
                  ...
                  return {
                    ...
                    n: function (A, I) {
                      ...
                      for (
                        ...
                        if (((Q = 4), 4 == (0 | E))) {
                          for (; 4 != (0 | B); )
                            (h((((g + 4096) | 0) + (B << 9)) | 0, n, 255 & Q),
                              (B = (B + 1) | 0),
                              (Q = (Q + 1) | 0));
                          for (d(g), d((g + 4096) | 0), B = 0; 4 != (0 | B); ) {
                            for (
                              x(
                                (E = (((g + 2048) | 0) + (B << 9)) | 0),
                                (((g + 6144) | 0) + (B << 11)) | 0,
                      ...
                      for (; 1568 != (0 | o); )
                        ((C[(1536 + ((I + o) | 0)) | 0] = r[(A + o) | 0]),
                          (o = (o + 1) | 0));
                      return (X((I + 3104) | 0, A, 1568), v((I + 3136) | 0), 0);
                    },
                    o: function (A, I, g) {
                      var B, Q;
                      return (
                    ...
                    p: function (A, I, g) {
                      ...
                      for (
                        E = ((B = (D - 1696) | 0) + 1632) | 0,
                          Q = ((s = ((D = B) - 5120) | 0) + 3072) | 0,
                          n = A |= 0,
                          t = ((D = s) - 16) | 0;
                        4 != (0 | c);
                      ) {
                        for (f = (Q + (c << 9)) | 0, y = 0; 32 != (0 | y); ) {
                          for (
                            i[t >> 1] = r[0 | n] | (r[(n + 1) | 0] << 8),
                              i[(t + 2) >> 1] =
                                (r[(n + 2) | 0] << 5) | (r[(n + 1) | 0] >>> 3),
                              i[(t + 4) >> 1] =
                                (r[(n + 3) | 0] << 2) |
                              ...
                              i[(t + 12) >> 1] =
                                (r[(n + 9) | 0] << 6) | (r[(n + 8) | 0] >>> 2),
                              i[(t + 14) >> 1] =
                                (r[(n + 10) | 0] << 3) | (r[(n + 9) | 0] >>> 5),
                              G = y << 3,
                              a = 0;
                            8 != (0 | a);
                          )
                            ((i[(f + ((a + G) << 1)) >> 1] =
                              (e(2047 & o[(t + (a << 1)) >> 1], 3329) +
                                1024) >>>
                              11),
                              (a = (a + 1) | 0));
                          ((y = (y + 1) | 0), (n = (n + 11) | 0));
                      ...
                      for (D = (s + 5120) | 0; 32 != (0 | w); )
                        ((C[(1664 + ((B + w) | 0)) | 0] =
                          r[(3104 + ((I + w) | 0)) | 0]),
                          (w = (w + 1) | 0));
                      for (
                        P((t = (B + 1568) | 0), (n = (B + 1632) | 0), 64),
                          F(B, n, (I + 1536) | 0, (a = (B + 1600) | 0)),
                          n = 0;
                        1568 != (0 | n);
                      )
                        ((u = (r[(n + B) | 0] ^ r[(A + n) | 0]) | u),
                      ...
                      for (
                        ...
                        ((I = r[0 | (s = (A + t) | 0)]),
                          (C[0 | s] = I ^ (a & (I ^ r[(A + n) | 0]))),
                          (A = (A + 1) | 0));
                      return (N(g, 32, t, 64), (D = (B + 1696) | 0), 0);
                    },
                  };
                })(A)
              );
          ...
          instantiate: function (A, I) {
            return {
              then: function (g) {
                var B = new c.Module(A);
                g({ instance: new c.Instance(B, I) });
              },
            };
          },
          RuntimeError: Error,
        };
      ((e = []), "object" != A(c) && N("no native wasm support detected"));
      var D,
        y,
        w,
        u,
      ...
      ((F =
        ...
        (s = B.wasmMemory
          ? B.wasmMemory
          : new c.Memory({ initial: S / 65536, maximum: S / 65536 })),
        (h = s.buffer),
        (B.HEAP8 = D = new Int8Array(h)),
        (B.HEAP16 = new Int16Array(h)),
        (B.HEAP32 = w = new Int32Array(h)),
        (B.HEAPU8 = y = new Uint8Array(h)),
        (B.HEAPU16 = new Uint16Array(h)),
        (B.HEAPU32 = new Uint32Array(h)),
        (B.HEAPF32 = new Float32Array(h)),
        (B.HEAPF64 = u = new Float64Array(h)),
      ...
      function J(A) {
        return Promise.resolve().then(function () {
          return (function (A) {
            if (A == b && e) return new Uint8Array(e);
            var I = T(A);
            if (I) return I;
            if (g) return g(A);
            throw "both async and sync fetching of the wasm failed";
      ...
      function q(A, I, g, B) {
        return (function (A, I, g) {
          return J(A)
            .then(function (A) {
              return c.instantiate(A, I);
            })
            .then(function (A) {
              return A;
            })
            .then(g, function (A) {
              (a("failed to asynchronously prepare wasm: " + A), N(A));
            });
        })(I, g, B);
      }
      l((b = "<<< WASM_BINARY_FILE >>>")) ||
        ((M = b), (b = B.locateFile ? B.locateFile(M, r) : r + M));
      var L = {
        1572: function () {
            ...
            try {
              var I =
                  ...
                  ("undefined" == typeof window ? "undefined" : A(window))
                    ? window
                    : self,
                g = void 0 !== I.crypto ? I.crypto : I.msCrypto,
                Q = function () {
                  var A = new Uint32Array(1);
      ...
      var K,
        ...
        O = function (A, I, g) {
          var B = (function (A, I) {
            var g;
            for (W.length = 0, I >>= 2; (g = y[A++]); )
              ((I += (105 != g) & I),
                W.push(105 == g ? w[I] : u[I++ >> 1]),
                ++I);
            return W;
          })(I, g);
          return L[A].apply(null, B);
        },
        V = function (A) {
          (A, f || (B.onExit && B.onExit(A), (G = !0)), E(A, new x(A)));
        },
        j = {
          c: function (A, I, g) {
            return O(A, I, g);
      ...
      ((function () {
        ...
        function I(A, I) {
          ...
          return (
            ...
            (function (A) {
              if (
                (d--,
                B.monitorRunDependencies && B.monitorRunDependencies(d),
                0 == d && (null !== U && (clearInterval(U), (U = null)), Y))
              ) {
                var I = Y;
                ((Y = null), I());
              }
        ...
        if (
          ...
          try {
            ...
            return (
              a("Module.instantiateWasm callback failed with error: " + A),
              !1
            );
          }
        q(0, b, A, function (A) {
        ...
        (B._malloc = function () {
          return (B._malloc = B.asm.g).apply(null, arguments);
        }),
        (B._free = function () {
          return (B._free = B.asm.h).apply(null, arguments);
        }),
        (B._kyberjs_init = function () {
          return (B._kyberjs_init = B.asm.i).apply(null, arguments);
        }),
        (B._kyberjs_public_key_bytes = function () {
          return (B._kyberjs_public_key_bytes = B.asm.j).apply(null, arguments);
        }),
        (B._kyberjs_private_key_bytes = function () {
          return (B._kyberjs_private_key_bytes = B.asm.k).apply(
            null,
            arguments,
          );
        }),
        (B._kyberjs_cyphertext_bytes = function () {
          return (B._kyberjs_cyphertext_bytes = B.asm.l).apply(null, arguments);
        }),
        (B._kyberjs_secret_bytes = function () {
          return (B._kyberjs_secret_bytes = B.asm.m).apply(null, arguments);
        }),
        (B._kyberjs_keypair = function () {
          return (B._kyberjs_keypair = B.asm.n).apply(null, arguments);
        }),
        (B._kyberjs_encrypt = function () {
          return (B._kyberjs_encrypt = B.asm.o).apply(null, arguments);
        }),
        (B._kyberjs_decrypt = function () {
          return (B._kyberjs_decrypt = B.asm.p).apply(null, arguments);
        }));
      function T(A) {
        if (l(A))
          return (function (A) {
      ...
      if (
        ((B.writeArrayToMemory = function (A, I) {
          D.set(A, I);
        }),
        (Y = function A() {
          (K || Z(), K || (Y = A));
  ...
  var n = Q.ready.then(function () {
    (Q._kyberjs_init(),
      (A = Q._kyberjs_public_key_bytes()),
      (I = Q._kyberjs_private_key_bytes()),
      (g = Q._kyberjs_cyphertext_bytes()),
      (B = Q._kyberjs_secret_bytes()));
  });
  return {
    ...
    keyPair: function () {
      return n.then(function () {
        var g = Q._malloc(A),
          B = Q._malloc(I);
        try {
          return E(Q._kyberjs_keypair(g, B), {
            publicKey: C(g, A),
            privateKey: C(B, I),
          });
        } finally {
    ...
    encrypt: function (I) {
      return n.then(function () {
        var n = Q._malloc(A),
          r = Q._malloc(g),
          o = Q._malloc(B);
        Q.writeArrayToMemory(I, n);
        try {
          return E(Q._kyberjs_encrypt(n, r, o), {
            cyphertext: C(r, g),
            secret: C(o, B),
          });
        } finally {
    ...
    decrypt: function (A, r) {
      return n.then(function () {
        var n = Q._malloc(g),
          o = Q._malloc(I),
          t = Q._malloc(B);
        (Q.writeArrayToMemory(A, n), Q.writeArrayToMemory(r, o));
        try {
          return E(Q._kyberjs_decrypt(n, o, t), C(t, B));
        } finally {
          (i(n), i(o), i(t));
        }
      });
...
"undefined" != typeof module && module.exports
  ? ((kyber.kyber = kyber), (module.exports = kyber))
  : (self.kyber = kyber);
